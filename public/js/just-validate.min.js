...
!function () {
    for (var e = ["DocumentType", "Element", "CharacterData"], t = function () {
        ...
        var i = e[r];
        window[i] && !window[i].prototype.remove && (window[i].prototype.remove = t)
    }
}(), function (e) {
    function t() {
    }
    ...
    function n(e, t) {
        ...
        return 0 === e._state ? void e._deferreds.push(t) : (e._handled = !0, void i._immediateFn(function () {
            ...
            if (null === r) return void (1 === e._state ? o : s)(t.promise, e._value);
            var i;
            try {
                i = r(e._value)
            } catch (n) {
    ...
    i.prototype["catch"] = function (e) {
        ...
        return e && "object" === ("undefined" == typeof e ? "undefined" : _typeof(e)) && e.constructor === i ? e : new i(function (t) {
            t(e)
        })
    }, i.reject = function (e) {
    ...
    f.prototype = {
        ...
        handlerKeyup: function (e) {
            var t = e.target, r = {name: t.getAttribute("data-validate-field"), value: t.value};
            delete this.result[r.name], this.validateItem({
                name: r.name,
                value: r.value,
                group: [],
                isKeyupChange: !0
        ...
        getElementsRealValue: function () {
            for (var e = this.$form.querySelectorAll("*"), t = void 0, r = {}, i = 0, n = e.length; i < n; ++i) if (t = e[i].getAttribute("name")) {
        ...
        setForm: function (e) {
            ...
            this.$form = e, this.$form.setAttribute("novalidate", "novalidate"), this.$form.addEventListener("submit", function (e) {
                return e.preventDefault(), t.result = [], t.getElements(), t.promisesRemote.length ? void Promise.all(t.promisesRemote).then(function () {
                    t.promisesRemote = [], t.isValidationSuccess && t.validationSuccess()
        ...
        getElements: function () {
            ...
            for (var r = function (r, i) {
                var n = t[r], o = n.getAttribute("data-validate-field"), s = n.value, a = !1, l = [];
                if ("checkbox" === n.type && (s = n.checked || "", n.addEventListener("change", function (t) {
                    var r = t.target, i = {name: r.getAttribute("data-validate-field"), value: r.checked};
                    delete e.result[i.name], e.validateItem({name: i.name, value: i.value, group: []}), e.renderErrors()
                })), "radio" === n.type) {
                    ...
                    u ? (u.group.push(n.checked), a = !0) : l.push(n.checked), n.addEventListener("change", function (t) {
                        var r = t.target, i = {name: r.getAttribute("data-validate-field"), value: r.checked};
                        delete e.result[i.name], e.validateItem({
                            name: i.name,
                            value: i.value,
                            group: []
                        }), e.renderErrors()
        ...
        validateRemote: function (e) {
            var t = e.value, r = e.name, i = e.url, n = e.successAnswer, o = e.sendParam, s = e.method;
            return new Promise(function (e) {
                h({
                    url: i, method: s, data: _defineProperty({}, o, t), async: !0, callback: function (t) {
                        t.toLowerCase() === n.toLowerCase() && e("ok"), e({type: "incorrect", name: r})
                    }, error: function () {
                        e({type: "error", name: r})
                    }
                })
        ...
        generateMessage: function (e, t, r) {
            var i = this.messages || this.defaultMessages,
                n = i[t] && i[t][e] || this.messages && "string" == typeof this.messages[t] && i[t] || this.defaultMessages[e] || this.DEFAULT_REMOTE_ERROR;
            r && (n = n.replace(":value", r.toString())), this.result[t] = {message: n}
        },
        ...
        clearErrors: function () {
            for (var e = document.querySelectorAll(".js-validate-error-label"), t = 0, r = e.length; t < r; ++t) e[t].remove();
            e = document.querySelectorAll(".js-validate-error-field");
            for (var i = 0, n = e.length; i < n; ++i) e[i].classList.remove("js-validate-error-field"), e[i].style.border = "", e[i].style.color = ""
        },
        renderErrors: function () {
            ...
            for (var t in this.result) {
                var r = this.result[t].message, i = this.$form.querySelectorAll('[data-validate-field="' + t + '"]'),
                    n = i[i.length - 1], o = document.createElement("div");
                if (o.innerHTML = r, o.className = "js-validate-error-label", o.setAttribute("style", "color: " + this.colorWrong), n.style.border = "1px solid " + this.colorWrong, n.style.color = "" + this.colorWrong, n.classList.add("js-validate-error-field"), "checkbox" === n.type || "radio" === n.type) {
        ...
        lockForm: function () {
            for (var e = this.$form.querySelectorAll("input, textarea, button, select"), t = 0, r = e.length; t < r; ++t) e[t].setAttribute("disabled", "disabled"), e[t].style.pointerEvents = "none", e[t].style.webitFilter = "grayscale(100%)", e[t].style.filter = "grayscale(100%)"
        },
        unlockForm: function () {
            for (var e = this.$form.querySelectorAll("input, textarea, button, select"), t = 0, r = e.length; t < r; ++t) e[t].removeAttribute("disabled"), e[t].style.pointerEvents = "", e[t].style.webitFilter = "", e[t].style.filter = ""
        }
    }, e.JustValidate = f
}(window);